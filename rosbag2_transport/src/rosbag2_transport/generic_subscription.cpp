...
rcl_subscription_options_t rcl_subscription_get_unreliable_options() {
...
GenericSubscription::GenericSubscription(
    ...
    : SubscriptionBase(node_base, ts, topic_name,
                       rcl_subscription_get_unreliable_options(), true),
      default_allocator_(rcutils_get_default_allocator()), callback_(callback) {
}
...
void GenericSubscription::handle_message(
  ...
  (void)message_info;
  auto typed_message =
      std::static_pointer_cast<rmw_serialized_message_t>(message);
...
GenericSubscription::borrow_serialized_message(size_t capacity) {
  ...
  *message = rmw_get_zero_initialized_serialized_message();
  auto init_return =
      rmw_serialized_message_init(message, capacity, &default_allocator_);
  ...
  auto serialized_msg = std::shared_ptr<rmw_serialized_message_t>(
      message, [](rmw_serialized_message_t *msg) {
